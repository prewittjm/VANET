    ...
    private class Broadcaster extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                ...
                Packet newPacket = new Packet(currentSN, getHostname(), (int) getMyID(), (int) getMyID(), getSpeed(), getxCoordinate(), getyCoordinate(), System.currentTimeMillis(), getIfInRoadTrain());
